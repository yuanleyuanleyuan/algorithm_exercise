 ...
 * <p><strong>编号：</strong>13</p>
 * <p><strong>标题：</strong>罗马数字转整数</p>
 * <p><strong>时间：</strong>2022-07-03 14:52:12</p>
 *
 ...
 * </ul>
 *
 * <br><div><strong>Topics：</strong><div><li>哈希表</li><li>数学</li><li>字符串</li></div></div>
 *
    ...
    class Solution {
        public int romanToInt(String s) {
            ...
            for (int i = 0; i < length; i++) {
                switch (chars[i]) {
                    case 'I':
                        if (i != chars.length - 1 && (chars[i + 1] == 'X' || chars[i + 1] == 'V')) {
                            num -= 1;
                        } else {
                            num += 1;
                        }
